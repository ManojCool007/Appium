...
public class HAndMFlow5 extends BaseClass {
	...
	public void script() throws Throwable
	{
		...
		myfavouritespage.clickOnAddBtn();
		myfavouritespage.selectLarge_size();
		
		homepage.clickshoppingBagBtn();
		
		ShoppingBagPage shoppingBagPage = new ShoppingBagPage(driver);
		System.out.println("Jacket is succeccfully added : "+ shoppingBagPage.fetchJacket_name());
		shoppingBagPage.clickOnRemove();
